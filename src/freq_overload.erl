...
-export([add/2, delete/2, start_link/0]).

-export([frequency_available/0, frequency_denied/0,
	 no_frequency/0]).
...
no_frequency() ->
    gen_event:notify(?MODULE,
		     {set_alarm, {no_frequency, self()}}).
